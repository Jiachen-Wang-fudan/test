...
samtools view -F 4 -@ 4 -c ${id}_rmptmt_q20_s1_fixmate_s2_markdup.bam
echo "sam_count"
echo "rmptmt_count"
echo "q20_count"
echo "markdup_count"
...
mkdir Bed ; mv *.bed Bed;mv Bed Bam ; mkdir BPMbigwig ; mv *BPM.bigwig BPMbigwig ; mkdir RPGCbigwig ; mv *RPGC.bigwig RPGCbigwig
mkdir track ; mv BPMbigwig track ; mv RPGCbigwig track ; mv RPKMbigwig track ; mv RPKMbigwig_e track
echo "bigwig done"
#4.fragmentsize size
